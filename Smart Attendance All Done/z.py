        ...
        for row in self.rows:
            for i in range (self.day+2):
                if i == 0:
                    ...
                    self.val.append(self.registration_number)
                else:
                    ...
                    if len(x)==0:
                        ...
                        self.val.append(x[0][0])

            self.tree.insert('','end',values=tuple(self.val)) 
            self.value1234.extend(self.val)
            j+=1
            self.val.clear()
